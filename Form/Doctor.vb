...
Public Class Doctor
    ...
    Private bsClinic As New BindingSource
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            Using frm As New DoctorDetail(userId)
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            If Me.dgvList.Rows.Count > 0 Then
                Dim employeeId As Integer = CType(Me.bsClinic.Current, DataRowView).Item("EmployeeId")
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Try
            If Me.dgvList.Rows.Count > 0 Then
                ...
                Using frm As New DoctorDetail(userId, employeeId)
                    If frm.ShowDialog(Me) = DialogResult.OK Then
                        Reload()
                    End If
                End Using
    ...
    Private Sub LoadClinic()
        Try
            ...
            If isFilterByEmployeeName = True Then
                ...
                dtClinic = dbMethod.FillDataTable("RdDoctorByEmployeeName", CommandType.StoredProcedure, prmPart)
            ...
            ElseIf isFilterByStatus = True Then
                ...
                dtClinic = dbMethod.FillDataTable("RdDoctorByStatus", CommandType.StoredProcedure, prmPart)
                totalCount = prmPart(2).Value
            ...
            Else
                ...
                dtClinic = dbMethod.FillDataTable("RdDoctor", CommandType.StoredProcedure, prmPart)
                totalCount = prmPart(2).Value
            End If

            bsClinic.DataSource = dtClinic
            bsClinic.ResetBindings(True)
            dgvList.AutoGenerateColumns = False
            dgvList.DataSource = bsClinic
