...
Public Class MedicineIssue
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            If CInt(txtQty.Text) > CInt(txtCurrentStock.Text) Then
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If cmbReceiver.SelectedValue = 0 Then
                MessageBox.Show("Please select issuer of items.", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                cmbReceiver.Focus()
                Exit Sub
            End If

            If dgvTrxDetail.Rows.Count = 0 Then
                MessageBox.Show("Please select items to issue.", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                cmbMedicine.Focus()
                Exit Sub
            End If
    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If trxId = 0 Then
            ...
            dbMethod.FillCmbWithCaption("SELECT A.MedicineId, TRIM(MedicineName) AS MedicineName " &
                                        ...
                                        CommandType.Text, "MedicineId", "MedicineName", cmbMedicine, "", prmRd)
